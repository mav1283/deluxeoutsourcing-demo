    ...
    return (
        <section className='faq-contact sect'>
            ...
            <form className="faq-contact-form">
                ...
                <label htmlFor="" className="form-group"><textarea placeholder="Question"></textarea></label>
                <label htmlFor="" className="form-group check">
                    <input type="checkbox"/><span>We value your privacy. You agree to MicroSourcing's collection statement</span>
                </label>
                <label htmlFor="" className="form-group check">
                    <input type="checkbox"/><span>Yes, I'd like free access to an in-depth course about offshoring to the Philippines.
</span>
                </label>
